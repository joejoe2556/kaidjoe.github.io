...
function calculateResults() {
  ...
  const chassisImage = `<img src="pilotexam-test/images/${topChassis}.jpg" alt="${topChassis} Chassis">`;
  const gunImage = `<img src="pilotexam-test/images/${topGun}.png" alt="${topGun} Gun">`;
